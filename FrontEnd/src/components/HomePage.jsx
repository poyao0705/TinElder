...
const HomePage = () => {
  ...
  return (
    <div className="relative p-4 md:p-8 lg:p-12 cursor-pointer">
      {/* Top Gradient Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div
          ...
          className="backdrop-blur-[42px] bg-opacity-30 rounded-[40px] border-4 border-white shadow-md flex flex-col items-center justify-between p-4"
        >
          <img
